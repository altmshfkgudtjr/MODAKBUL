        ...
        for (let i=0; i<result_list.length; i++) {
            if (Array.isArray(result_list[i]) === true) {
                ...
                for (let j=1; j<result_list[i].length; j++) {
                    subboard += '<a href="/board?type=' + result_list[i][j].board_url + '"  class="M_nav_user_button">' +
                ...
                result_html +=
                    ...
                    '</i>' + result_list[i][0].board_name + '<i id="M_dropdown_icon_competition" class="fas fa-sort-down M_dropdown_icon"></i></a></li>'+
